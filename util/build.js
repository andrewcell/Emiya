...
try {
    ...
    childProcess.execSync('javascript-obfuscator ./dist/public/scripts --output ./ --compact true --self-defending true --control-flow-flattening false --debug-protection true --target browser-no-eval')
